...
def twitter_setup(): # Function to set-up credentials
    ...
    auth.set_access_token(ACCESS_TOKEN, ACCESS_TOKEN_SECRET) # Personal access key. Remember to check that your bot is not "read-only" mode, if you change to read-write, then regenerate the access token.
